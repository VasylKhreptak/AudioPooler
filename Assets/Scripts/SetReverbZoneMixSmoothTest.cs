...
public class SetReverbZoneMixSmoothTest : MonoBehaviour
{
    [Header("References")]
    ...
    [SerializeField] private float _to = 1.1f;
    ...
    private void Update()
    {
        ...
        {
            _audioPooler.SetReverbZoneMix(_ID, _from);
            _audioPooler.SetReverbZoneMixSmooth(_ID, _to, 2f, _stopOnComplete);
        }

        if (Input.GetMouseButtonDown(2))
        {
            _audioPooler.StopUpdatingReverbZoneMix(_ID);
        }
    }
