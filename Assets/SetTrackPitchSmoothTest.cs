...
public class SetTrackPitchSmoothTest : MonoBehaviour
{
    [Header("References")]
    ...
    {
        _audioPooler.SetTrackPitch(_mixer, _name, _startValue);
        _audioPooler.SetTrackPitchSmooth(_mixer, _name, _targetValue, _time);
    }
}
